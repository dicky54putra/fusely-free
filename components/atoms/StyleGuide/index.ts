...
const typographyClass = (props?:string) => { 
  const data = {
    h1: ['sm:text-h1 sm:leading-h1 font-serif text-h1sm font-bold leading-h1sm', props].join(" "),
    h2: ['sm:text-h2 sm:leading-h2 font-serif text-h2sm font-bold leading-h2sm', props].join(" "),
...
const buttonClass = (variant?: string, size?:string) => {
  const data = {
    primary: "rounded-sm py-4 px-8 bg-cyan-900 text-[14px] text-white font-bold font-sans box-border border border-cyan-900",
    outlined: "rounded-sm py-4 px-8 bg-transparent text-[14px] text-cyan-900 font-bold font-sans box-border border border-cyan-900",
    white: "rounded-sm py-4 px-8 bg-transparent text-[14px] text-cyan-900 font-bold font-sans box-border border border-white"
  }
  return data;
}
